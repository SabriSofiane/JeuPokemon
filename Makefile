...
pokemon: objets/start_game.o objets/audio.o objets/collisions.o objets/event.o objets/initialisation.o objets/map.o objets/global_structure.o objets/player.o objets/string_matrice.o objets/text.o objets/textures.o objets/window_render.o objets/menu.o objets/controller.o objets/combat.o objets/main.o
	gcc -o bin/pokemon objets/start_game.o objets/audio.o objets/collisions.o objets/event.o objets/initialisation.o objets/map.o objets/global_structure.o objets/player.o objets/string_matrice.o objets/text.o objets/textures.o objets/window_render.o objets/menu.o objets/controller.o objets/combat.o  objets/main.o -I include/SDL2 -L lib/ -lmingw32 -lSDL2main -lSDL2 -lSDL2_image -lSDL2_mixer -lSDL2_ttf
...
objets/global_structure.o: src/global_structure.c
	gcc -o  objets/global_structure.o -c src/global_structure.c -I include/SDL2 -L lib/ -lmingw32 -lSDL2main -lSDL2 -lSDL2_image -lSDL2_mixer -lSDL2_ttf
